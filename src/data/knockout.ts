...
const r32: KnockoutMatch[] = [
  mk("K1", "R32", 0, "2A", "2C"),
  mk("K2", "R32", 1, "1B", "3A/C/D/E"),
  mk("K3", "R32", 2, "1F", "2B"),
  mk("K4", "R32", 3, "1C", "2F"),
  mk("K5", "R32", 4, "1I", "3C/D/F/H"),
  mk("K6", "R32", 5, "2E", "2I"),
  mk("K7", "R32", 6, "1A", "3C/E/F/H/I"),
  mk("K8", "R32", 7, "1E", "2D"),
  mk("K9", "R32", 8, "2J", "2H"),
  mk("K10", "R32", 9, "1D", "3B/E/F/I/J"),
  mk("K11", "R32", 10, "1G", "3A/B/C/D/F"),
  mk("K12", "R32", 11, "1K", "3D/E/I/J/K"),
  mk("K13", "R32", 12, "1H", "2G"),
  mk("K14", "R32", 13, "1J", "2K"),
  mk("K15", "R32", 14, "2L", "3E/H/I/J/K"),
  mk("K16", "R32", 15, "1L", "2L"),
];

const r16: KnockoutMatch[] = [
  mk("R1", "R16", 16, "W K2", "W K1"),
  mk("R2", "R16", 17, "W K4", "W K3"),
  mk("R3", "R16", 18, "W K6", "W K5"),
  mk("R4", "R16", 19, "W K8", "W K7"),
  mk("R5", "R16", 20, "W K10", "W K9"),
  mk("R6", "R16", 21, "W K12", "W K11"),
  mk("R7", "R16", 22, "W K14", "W K13"),
  mk("R8", "R16", 23, "W K16", "W K15"),
];
